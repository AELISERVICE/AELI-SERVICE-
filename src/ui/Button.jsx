...
const VARIANT_CLASSES = {
    ...
    gradient: 'flex items-center gap-2 bg-gradient-to-r from-[#8B5CF6] to-[#FCE0D6] text-white px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 shadow-md shadow-purple-200',
}
