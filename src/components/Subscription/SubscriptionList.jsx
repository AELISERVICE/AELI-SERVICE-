    ...
    <div className="w-full">
      <div className="space-y-4 max-w-6xl">
        {isLoading ? (
          ...
          DATA.map((item) => (
            <Card key={item.id} className="backdrop-blur-sm p-4 sm:p-5 ">
              ...
              <div className="hidden sm:flex items-center gap-4 lg:gap-6">
                ...
                <div className="text-gray-500 text-sm lg:text-base min-w-[80px] text-center">
                  - {item.daysLeft} jours
                </div>
                ...
                <div className="font-semibold text-gray-800 text-sm lg:text-base min-w-[120px] text-right">
                  {item.price}
                </div>
              </div>
            </Card>
