...
const auditLogger = {
  ...
  providerUpdated: (req, provider, oldValues) =>
    logAudit({
      req,
      action: "UPDATE",
      entityType: "Provider",
  ...
  providerVerified: (req, provider, isVerified) =>
    logAudit({
      req,
      action: "UPDATE",
      entityType: "Provider",
  ...
  // Document operations
  documentsUploaded: (req, provider, documentsCount) =>
    logAudit({
      req,
      action: "CREATE",
      entityType: "Document",
  ...
  documentsReviewed: (req, provider, decision, notes) =>
    logAudit({
      req,
      action: "UPDATE",
      entityType: "Document",
      ...
      metadata: { notes },
      description: `Documents de "${provider.businessName}" ${
        decision === "approved" ? "approuvés" : "rejetés"
      }`,
    }),

  // User operations
  userStatusChanged: (req, user, isActive) =>
    logAudit({
      req,
      action: "UPDATE",
      entityType: "User",
  ...
  // Review moderation
  reviewModerated: (req, review, isVisible) =>
    logAudit({
      req,
      action: "UPDATE",
      entityType: "Review",
  ...
  passwordResetRequested: (req, user) =>
    logAudit({
      req,
      action: "OTHER",
      entityType: "User",
  ...
  // Export operations
  dataExported: (req, exportType, count) =>
    logAudit({
      req,
      action: "EXPORT",
